...
```python
  """
  code aims to automate interactions with the screen using Python's pyautogui library for posting in Facebook Marketplace across various groups
  """
...
def find_and_click_button(button_path):
    ...
    try:
        ...
        button_location = pag.locateOnScreen(button_path, confidence=0.7)
    ...
    while True:
            for X in range(30):
                ...
                if find_and_click_button(button_image_path):
                    ...
                    pag.press("esc")  # Нажатие ESC для отмены действия
